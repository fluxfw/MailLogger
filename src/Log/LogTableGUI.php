...
class LogTableGUI extends ilTable2GUI {
	...
	protected function fillRow(/*array*/
		...
		$actions->addItem(self::plugin()->translate("show_email", MailLoggerLogGUI::LANG_MODULE_LOG),'show',self::dic()->ctrl()->getLinkTargetByClass([ilUIPluginRouterGUI::class,MailLoggerLogGUI::class]),MailLoggerLogGUI::CMD_SHOW);

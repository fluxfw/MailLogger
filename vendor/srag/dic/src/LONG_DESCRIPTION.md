...
```php
use srag\DIC\MailLogger\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\MailLogger\x\Version\PluginVersionParameter;
...

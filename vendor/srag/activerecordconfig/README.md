...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\MailLogger\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\MailLogger\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\MailLogger\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
